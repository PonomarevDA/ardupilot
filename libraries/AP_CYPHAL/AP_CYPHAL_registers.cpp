...
static RegisterCell registers_table[CyphalRegisters::NUMBER_OF_REGISTERS] = {
    ...
    {"uavcan.sub.esc_heartbeat_0.id"},
    {"uavcan.sub.feedback_0.id"},
    {"uavcan.sub.power_0.id"},
    {"uavcan.sub.status_0.id"},
    {"uavcan.sub.dynamics_0.id"},

    {"uavcan.sub.esc_heartbeat_1.id"},
    {"uavcan.sub.feedback_1.id"},
    {"uavcan.sub.power_1.id"},
    {"uavcan.sub.status_1.id"},
    {"uavcan.sub.dynamics_1.id"},

    {"uavcan.sub.esc_heartbeat_2.id"},
    {"uavcan.sub.feedback_2.id"},
    {"uavcan.sub.power_2.id"},
    {"uavcan.sub.status_2.id"},
    {"uavcan.sub.dynamics_2.id"},

    {"uavcan.sub.esc_heartbeat_3.id"},
    {"uavcan.sub.feedback_3.id"},
    {"uavcan.sub.power_3.id"},
...
{
    GCS_SEND_TEXT(MAV_SEVERITY_WARNING, "v1: CyphalRegisterAccessRequest");
...
{
    GCS_SEND_TEXT(MAV_SEVERITY_WARNING, "v1: CyphalRegisterListRequest");
