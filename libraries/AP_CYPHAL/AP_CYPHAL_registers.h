...
enum CyphalRegister_t {
    ...
    UAVCAN_SUB_GPS_POINT_ID,
    UAVCAN_SUB_GPS_YAW_ID,
...
{
public:
    static constexpr uint8_t NUMBER_OF_INTEGER_REGISTERS = 32;
    static constexpr uint8_t NUMBER_OF_STRING_REGISTERS = 30;
